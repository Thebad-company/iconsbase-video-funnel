      ...
      <div className="container-editorial flex items-center justify-between h-16">
        <Link to="/" className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-sm bg-navy flex items-center justify-center">
            <span className="font-display text-navy-foreground text-sm leading-none">I</span>
          </div>
          <span className="font-display text-base tracking-tight">IconsBase</span>
        </Link>
    ...
    <footer className="border-t border-border mt-32">
      <div className="container-editorial py-16 grid md:grid-cols-3 gap-12">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-base">IconsBase</span>
          </div>
      ...
      <div className="border-t border-border">
        <div className="container-editorial py-6 flex flex-col md:flex-row justify-between text-xs text-muted-foreground gap-2">
          <span>© {new Date().getFullYear()} IconsBase. All rights reserved.</span>
